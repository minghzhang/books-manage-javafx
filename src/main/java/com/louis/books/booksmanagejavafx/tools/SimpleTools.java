package com.louis.books.booksmanagejavafx.tools;

import com.louis.books.booksmanagejavafx.beans.BookBean;
...
public class SimpleTools {
    ...
    public void setBookTypeTableViewData(TableView tableView, ObservableList data,
    ...
    public void setBookTableViewData(TableView tableView, ObservableList data, TableColumn<BookBeanTableData, String> idColumn,
                                     TableColumn<BookBeanTableData, String> nameColumn,
                                     TableColumn<BookBeanTableData, String> authorColumn,
                                     TableColumn<BookBeanTableData, String> sexColumn,
                                     TableColumn<BookBeanTableData, String> priceColumn,
                                     TableColumn<BookBeanTableData, String> descriptionColumn,
                                     TableColumn<BookBeanTableData, String> typeColumn) {
    ...
    public ObservableList<BookBeanTableData> getBookTableViewData(String sql) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            BookBeanTableData td = new BookBeanTableData(String.valueOf(r.getBookId()), r.getBookName(), r.getBookAuthor(), r.getBookAuthorSex(), String.valueOf(r.getBookPrice()), r.getBookDescription(), r.getBookTypeId());
            data.add(td);
        }
        return data;
    }
